    ...
    <main className={`block ${opensans.className}`}>
      ...
      <div className="section-padding text-center">
        <div className="baseContainer">
          <h1 className="text-color font-black text-7xl">
            VISUAL EFFECTS
          </h1>
          <p className="text-color text-3xl font-light">
            FILMS | ARCHITECTURAL | COMMERCIALS | GAMES
          </p>
          <Link href="/works" className="homepage-btn btn-color ">See Our Works</Link>
        </div>
      </div>
      <Footer />
    </main>
