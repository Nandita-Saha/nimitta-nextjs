    ...
    <main className={`block ${opensans.className}`}>
      ...
      <div className="section-padding text-center">
        <div className="baseContainer">
          <h1 className="text-black font-light text-[40px] xl:text-7xl mb-2 lg:mb-6">About Us</h1>
          <p className="text-lg xl:text-3xl font-light mb-6">
          ...
          <h2 className="text-3xl lg:text-5xl text-black font-light mb-10">Our Team</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className=" col-span-1">
              <div className="team-member text-center">
                <Image src="/assets/about/vicky.jpg" width={500} className="rounded-lg inline-block " height={500} alt="VICKY KHATIK" />
                <p className="text-xl text-black font-bold text-center mt-2">VICKY KHATIK</p>
                <p className="text-lg xl:text-3xl text-color font-light text-center">Project Supervisor</p>
            ...
            <div className=" col-span-1">
              <div className="team-member text-center">
                <Image src="/assets/about/rohit.jpg" width={500} height={500} className="rounded-lg inline-block  " alt="ROHIT GUPTA" />
                <p className="text-xl text-black font-bold text-center mt-2">ROHIT GUPTA</p>
                <p className="text-lg xl:text-3xl text-color font-light text-center">FX & Lighting</p>
            ...
            <div className=" col-span-1">
              <div className="team-member text-center">
                <Image src="/assets/about/amit.jpg" width={500} height={500} className="rounded-lg inline-block " alt="AMIT KESHARI" />
                <p className="text-xl text-black font-bold text-center mt-2">AMIT KESHARI</p>
                <p className="text-lg xl:text-3xl text-color font-light text-center">Compositing & Matchmoving</p>
            ...
            <div className=" col-span-1">
              <div className="team-member text-center">
                <Image src="/assets/about/anil.jpg" width={500} height={500} className="rounded-lg inline-block " alt="ANIL SHAW" />
                <p className="text-xl text-black font-bold text-center mt-2">ANIL SHAW</p>
                <p className="text-lg xl:text-3xl text-color font-light text-center">Animation</p>
